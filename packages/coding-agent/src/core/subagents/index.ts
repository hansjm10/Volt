	...
	return [
		...
		},
		{
			...
			systemPrompt: [
				...
				"Follow any applicable delegation policy; otherwise remain local-first.",
				"If you delegate, use only researcher subagents for distinct, bounded questions.",
		...
		},
		{
			...
			systemPrompt: [
				...
				"Follow any applicable delegation policy; otherwise remain local-first.",
				"If you delegate, assign distinct, bounded questions to the available researcher, security-reviewer, or general roles.",
		...
		},
		{
			...
			systemPrompt: [
				...
				"Follow any applicable delegation policy; otherwise remain local-first.",
				"If you delegate, assign only distinct, bounded research questions to researcher subagents.",
