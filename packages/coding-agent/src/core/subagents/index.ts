	...
	return [
		...
		},
		{
			...
			systemPrompt: [
				...
				"When delegation is allowed by the base policy, delegate only distinct, bounded questions to researcher subagents.",
				"Do not duplicate research already assigned to the parent or another child.",
		...
		},
		{
			...
			systemPrompt: [
				...
				"Follow the base delegation policy; coordinate child work only when delegation is allowed there.",
				"If delegated work is used, assign distinct, bounded questions to the available researcher, security-reviewer, or general roles.",
		...
		},
		{
			...
			systemPrompt: [
				...
				"When delegation is allowed by the base policy, delegate only distinct, bounded research questions to researcher subagents.",
