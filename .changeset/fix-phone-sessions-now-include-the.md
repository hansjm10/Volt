...
improvement(remote): The default phone tool grant now includes the inspect and lsp tools, so Plan mode on a paired device can use vetted Git/GitHub inspection and language-server reads like the TUI. ([#153](https://github.com/volt-hq/Volt/issues/153))
